        ...
        <Box>
          <Flex justifyContent={'space-between'}>
            <Box>
              ...
              >
                All Filters
                <DrawerExample3 prop={{ onClose, onOpen, btnref, isOpen }} />
              </Button>
            ...
            <Box border={'1px solid red'} mr='4' >
              <Select 
                color="black"
                fontSize={"large"}
                py={6}
                bg="none "
                border="1px solid black" placeholder="Sort By">
                <option  value="option1">Accending </option>
