      ...
      <Box mx='4' my='10'>
        ...
        <Box>
         ...
         <Box mr='20' pr='20' pos='sticky' top='0' h='fit-content'>
          ...
          <Text as='p'><StarIcon/> 4.7 (7)</Text>
          <Text as='p' pt='2' fontWeight='600'>LIMITED-TIME SPECIAL</Text>
          <Text><Text as='b' color='orange'>INR 2,567.00</Text> <Text as='s'>INR 5,563.00</Text><Text as='u' p='2'>Details</Text></Text>
          ...
          <Box><Button p='6'color='white' bg='black' w='80%' fontWeight='600'm='4' border='1px solid black'>Add To Bag</Button></Box>
         </Box>
        </Flex>
      </Box>
    </div>
